...
// 🛑 NEW: Component to handle R3F hooks that require the Canvas context
...
  const loadedTex = useTexture(texturePath); 
...
  const [isMobile, setIsMobile] = useState(false);
  // 🛑 REMOVED: const { gl } = useThree(); is moved into ColorSpaceManager
...
  }, []);
  ...
  // 🛑 REMOVED: useEffect for gl.outputColorSpace is moved into ColorSpaceManager
...
      >
        {/* 🚀 ADDED: The new component is placed inside the Canvas */}
        <ColorSpaceManager /> 
